...
// console.log(project.committee)
//
// console.log(names)
// console.log(projects)

  project.steps.forEach(function(step, index){
    step.committeeMember = project.committee[index % project.committee.length];

  });

// console.log(project.committee.push("Val"))
console.log(project)
console.log(project.committee.length)
